...
setup(
    ...
    version='0.7.4',
    description=
    'HyPerBAND on STERoids, a distributed Hyperband implementation with lots of room for improvement',
    ...
    python_requires='>=3',
    install_requires=[
        'Pyro4', 'serpent', 'ConfigSpace', 'numpy', 'statsmodels', 'scipy', 'netifaces'
    ],
    extras_require={
